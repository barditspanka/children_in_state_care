...
keep if hometype6==. & (hometype8==2 | hometype8==3)
...
compress
save "Output_data/CISC_regdata_m6sc8_temp.dta", replace
...
merge 1:m county_gr6 year using "Output_data/CISC_regdata_m6sc8_temp.dta", nogen keep(using match)
...
compress
save "Output_data/CISC_regdata_m6sc8.dta", replace
