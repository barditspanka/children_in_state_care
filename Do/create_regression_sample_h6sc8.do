...
*keep homchangers (home 6th, statceare 8)
keep if hometype6==0 & (hometype8==2 | hometype8==3)
...
compress
save "Output_data/CISC_regdata_h6sc8_temp.dta", replace
...
merge 1:m county_gr6 year using "Output_data/CISC_regdata_h6sc8_temp.dta", nogen keep(using match)

sort anon t

compress
save "Output_data/CISC_regdata_h6sc8.dta", replace
