...
****	When prompted, paste the vector of p-values you are testing into the "pval" variable. The p values are stired in Input_data/p_values_for_fdr.xls, but can copy from regression tables as well
